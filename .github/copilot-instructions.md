...
There are five problems (from kadai-a to kadai-e).
While kadai-a and kadai-e have their own folders, kadai-b through kadai-d share a single folder
(`kadai-bcd`). Although the source code is shared among kadai-b through kadai-d, provide clear
feedback on each problem rather than reviewing the entire shared codebase.
